...
class CuckooReport(DataSource):
    ...
    def __init__(self, cuckoo_report: str) -> None:
        ...
        #Added new line below by Ali Suwanda 19052020
        self.processes2 = self.report["behavior"]["processes"]
    ...
    def global_network_events(self) -> Generator[dict, None, None]:
        ...
        root_proc = None
        if root_proc_name:
            process_call = list(self.threads.values())
            ...
            for call in process_call:
                #comment by Ali Suwanda 19052020
                    ...
                    yield {
                        ...
                        #begin comment by Ali Suwanda 19052020
                        ...
                        #end comment by Ali Suwanda 19052020
                    }
